...
export const procedureConfig: LayoutConfig = {
  ...
  rows: [
    ...
    { key: "procedure", component: "editable", label: "Ablaufbeschreibung", description: "Schrittweise Durchführung mit Verantwortlichkeiten", icon: ListChecks, iconColor: "text-orange-600", emptyText: "Noch keine Schritte dokumentiert", requirement: "required" },
    ...
    { key: "documents", component: "editable", label: "Mitgeltende Unterlagen", description: "Referenzierte Dokumente, Normen und Formulare", icon: FileStack, iconColor: "text-blue-600", emptyText: "Keine mitgeltenden Unterlagen" },
...
export const policyConfig: LayoutConfig = {
  rows: [
    ...
    { key: "references", component: "editable", label: "Referenzen & mitgeltende Dokumente", description: "Verknüpfte Normen, Gesetze und Dokumente", icon: FileStack, iconColor: "text-blue-600", emptyText: "Keine Referenzen angegeben" },
  ],
};
...
export const workInstructionConfig: LayoutConfig = {
  rows: [
    ...
    { key: "steps", component: "editable", label: "Arbeitsschritte", description: "Detaillierte Schritt-für-Schritt-Anleitung", icon: ListOrdered, iconColor: "text-orange-600", emptyText: "Noch keine Arbeitsschritte dokumentiert" },
    ...
    { key: "documents", component: "editable", label: "Mitgeltende Unterlagen", description: "Referenzierte Dokumente und Formulare", icon: FileStack, iconColor: "text-blue-600", emptyText: "Keine mitgeltenden Unterlagen" },
  ],
};
...
export const meetingProtocolConfig: LayoutConfig = {
  rows: [
    ...
    { key: "discussion", component: "editable", label: "Besprechungspunkte", description: "Ergebnisse und Diskussion zu den Tagesordnungspunkten", icon: MessageSquare, iconColor: "text-purple-600", emptyText: "Noch keine Besprechungspunkte dokumentiert" },
...
export const trainingResourceConfig: LayoutConfig = {
  rows: [
    ...
    { key: "content", component: "editable", label: "Schulungsinhalt", description: "Gliederung und Inhalte der Schulung", icon: GraduationCap, iconColor: "text-purple-600", emptyText: "Noch keine Schulungsinhalte dokumentiert" },
...
export const useCaseConfig: LayoutConfig = {
  rows: [
    ...
    { key: "main_flow", component: "editable", label: "Normalablauf", description: "Schrittweiser Ablauf im Erfolgsfall", icon: ArrowRight, iconColor: "text-blue-600", emptyText: "Noch kein Normalablauf dokumentiert", required: true },
