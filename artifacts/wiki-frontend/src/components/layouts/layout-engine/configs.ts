...
export const procedureConfig: LayoutConfig = {
  ...
  rows: [
    ...
    {
      key: "relations",
      component: "section_block_editor",
  ...
  legacyFields: [
    {
      key: "qualifications",
      showWhen: (f) =>
        Boolean(f.qualifications) && !f.competencies_professional,
      label: "Qualifikationen & Anforderungen (Legacy)",
      description:
        "Fachliche und persönliche Anforderungen – bitte in die neuen Kompetenzfelder überführen",
      icon: GraduationCap,
    ...
    },
    {
      ...
      description:
        "Entscheidungs- und Handlungsbefugnisse – bitte in Budget- & Personalverantwortung überführen",
      icon: Wallet,
      iconColor: "text-gray-400",
    },
  ],
...
export const glossaryConfig: LayoutConfig = {
  ...
  rows: [{ key: "terms", component: "term_repeater" }],
};
...
export const meetingProtocolBottomConfig: LayoutConfig = {
  ...
  rows: [
    {
      key: "open_points",
      component: "agenda_editor",
      label: "Offene Punkte / Klärungsbedarf",
      icon: MessageSquare,
      iconColor: "text-yellow-600",
      emptyText: "Keine offenen Punkte erfasst",
    },
    {
      key: "action_items",
      component: "section_block_editor",
...
export const meetingProtocolConfig: LayoutConfig = {
  pageTypeKey: "meeting_protocol",
  rows: [...meetingProtocolTopConfig.rows, ...meetingProtocolBottomConfig.rows],
};
  ...
  rows: [
    {
      ...
      icon: Flag,
      iconColor: "text-primary",
      emptyText: "Noch keine strategische Leitentscheidung erfasst",
    },
    {
      key: "brand_purpose",
      component: "editable",
      ...
      icon: Target,
      iconColor: "text-primary",
      emptyText: "Noch kein Markenauftrag beschrieben",
    },
    {
      key: "brand_role",
      component: "editable",
      ...
      icon: Layers,
      iconColor: "text-primary",
      emptyText: "Noch keine Markenrolle beschrieben",
    },
    {
      key: "brand_mandate",
      component: "editable",
      ...
      icon: Gavel,
      iconColor: "text-primary",
      emptyText: "Noch kein Mandat definiert",
    },

    {
      ...
      icon: Users,
      iconColor: "text-blue-600",
      emptyText: "Noch keine Zielgruppen benannt",
    },
    {
      key: "core_promise",
      component: "editable",
      ...
      icon: Heart,
      iconColor: "text-primary",
      emptyText: "Noch kein Kernversprechen formuliert",
    },
    {
      key: "service_logic",
      component: "editable",
      ...
      icon: PackageOpen,
      iconColor: "text-blue-600",
      emptyText: "Noch keine Leistungslogik beschrieben",
    },

    {
      ...
      icon: ArrowLeftRight,
      iconColor: "text-primary",
      emptyText: "Noch keine Abgrenzung dokumentiert",
    },
    {
      ...
      icon: Ban,
      iconColor: "text-red-600",
      emptyText: "Noch keine Markenprinzipien festgelegt",
    },

    {
      ...
      icon: Brain,
      iconColor: "text-primary",
      emptyText: "Noch keine Leitidee beschrieben",
    },
    {
      ...
      icon: MessageSquare,
      iconColor: "text-primary",
      emptyText: "Noch kein Hauptclaim hinterlegt",
    },
    {
      key: "tonality",
      component: "editable",
      ...
      icon: MessageSquare,
      iconColor: "text-blue-600",
      emptyText: "Noch kein Tonalitätskern beschrieben",
    },

    {
      key: "references",
      component: "references_editor",
