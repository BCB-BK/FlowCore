# Replit-Auftragspaket – Cluster 1 bis 3

Dieses Dokument ist so formuliert, dass du die Cluster **nacheinander direkt an Replit geben** kannst.
...
## Globale Delivery-Regeln für alle drei Cluster
...
# Zusatzhinweis für dich

Die wichtigste fachliche Korrektur steckt in Cluster 2:

- **Ein einziges Feld kann nicht zugleich „hierarchisch sprechende Nummer“ und „für immer unveränderbare Identität“ sein**, wenn du später Inhalte sauber verschieben willst.
- Professionell ist deshalb ein **Dualmodell aus stabiler ID + sichtbarer Hierarchienummer**.
- Dasselbe gilt für **Version vs. Revision**: Eine professionelle Pflegehistorie braucht beides, getrennt modelliert.

Wenn du willst, ist der nächste sinnvolle Schritt danach ein zweites Dokument mit **Cluster 4, 5 und 6** im selben Replit-Format: Startseite/Informationsarchitektur, Seitentypen/Templates und moderner Editor inklusive Video-/Medien-Embedding.
