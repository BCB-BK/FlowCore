 ...
 */
export const GetNodeSiblingsParams = zod.object({
  nodeId: zod.coerce.string().uuid(),
});

export const GetNodeSiblingsResponseItem = zod.object({
  id: zod.string().uuid(),
  immutableId: zod.string(),
  displayCode: zod.string(),
  title: zod.string(),
...
export const CreateWorkingCopyResponse = zod.object({
  ...
  content: zod.object({}).passthrough().nullish(),
  structuredFields: zod.object({}).passthrough().nullish(),
  editorSnapshot: zod.object({}).passthrough().nullish(),
  changeType: zod.enum([
    "editorial",
    "minor",
    "major",
  ...
  lastAiSummary: zod.string().nullish(),
  lastManualSummary: zod.string().nullish(),
  reviewerId: zod.string().nullish(),
...
export const UpdateWorkingCopyBody = zod.object({
  ...
  content: zod.object({}).passthrough().optional(),
  structuredFields: zod.object({}).passthrough().optional(),
  editorSnapshot: zod.object({}).passthrough().optional(),
  changeType: zod
    .enum(["editorial", "minor", "major", "regulatory", "structural"])
    .optional(),
  changeSummary: zod.string().optional(),
