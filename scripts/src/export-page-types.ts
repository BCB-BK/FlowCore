...
} from "../../lib/shared/src/page-types/registry.js";
...
const output = {
  _meta: {
    ...
    purpose:
      "FlowCore Enterprise Wiki – Page Type Registry Export for AI Audit",
  },
...
console.log(
  `Exported ${Object.keys(PAGE_TYPE_REGISTRY).length} page types to ${outPath}`,
);
